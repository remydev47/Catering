            ...
            <div className=" pl-20 pr-6 sm:pl-6 md:px-0">
                <div className="relative w-full max-w-xs mt-4 mb-10 ml-auto">
                 <img className="relative -top-4 -left-4" src="/images/service-3.jpg" alt="" />
                    ...
                    <div className="absolute -bottom-10 -left-16 m-2 bg-orange-400">
                        <span className="block text-4xl font-bold text-white font-serif lg:text-5xl"> 50+ </span>
                        <span className="block mt-2 text-base leading-tight text-white font-serif"> Team<br />Member</span>
                    </div>
                </div>
            </div>
        </div>
