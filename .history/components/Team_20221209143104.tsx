    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-6 mt-8 sm:grid-cols-3 md:mt-16 lg:gap-x-12">
            ...
            <div>
                ...
                <h1 className='text-center font-bold text-3xl text-gray-400'>Jener</h1>
                <p className='text-center text-base font-normal text-blue-400'>CATERER</p>
            </div>
        </div>

        <div className="mt-8 text-center md:mt-16">
            <a href="#" title="" className="inline-flex items-center justify-center py-4 font-semibold text-white transition-all duration-200 bg-orange-400 border border-transparent rounded-md px-14" role="button">VIEW WHOLE TEAM</a>
        </div>
    </div>
</section>
  )
