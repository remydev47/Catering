        ...
        <div className="grid max-w-md grid-cols-1 gap-6 mx-auto mt-8 lg:mt-16 lg:grid-cols-3 lg:max-w-full">
                ...
                <div className="p-5">
                    <div className="relative">
                        <a href="#" title="" className="block aspect-w-4 aspect-h-3">
                            <img className="object-cover w-full h-full" src="/images/blog3.jpg" alt="" />
                        </a>
                    ...
                    <p className="mt-5 text-2xl font-semibold">
                        <a href="#" title="" className="text-black"> We Can Help Find a Location that’s Right for You. </a>
                    </p>
            ...
            <div className="overflow-hidden bg-white rounded shadow">
                <div className="p-5">
                    <div className="relative">
                        <a href="#" title="" className="block aspect-w-4 aspect-h-3">
                            <img className="object-cover w-full h-full" src="/images/blog2.jpg" alt="" />
                        </a>
                    ...
                    <p className="mt-5 text-2xl font-semibold">
                        <a href="#" title="" className="text-black"> Catering Services for Fabulous Corporate Events. </a>
                    </p>
            ...
            <div className="overflow-hidden bg-white rounded shadow">
                <div className="p-5">
                    <div className="relative">
                        <a href="#" title="" className="block aspect-w-4 aspect-h-3">
                            <img className="object-cover w-full h-full" src="/images/blog1.jpg" alt="" />
                        </a>
                    ...
                    <p className="mt-5 text-2xl font-semibold">
                        <a href="#" title="" className="text-black"> Planning a Wedding Menu Can Be Daunting. </a>
                    </p>
                    <p className="mt-4 text-base text-gray-600">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
                    <a href="#" title="" className="inline-flex items-center justify-center pb-0.5 mt-5 text-base font-semibold text-blue-600 transition-all duration-200 border-b-2 border-transparent hover:border-blue-600 focus:border-blue-600">
                        Continue Reading
