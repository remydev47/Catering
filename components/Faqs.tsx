...
const Faqs = () => {
  return (
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <p className="text-center text-gray-600 textbase mt-9">Didn’t find the answer you are looking for? <a href="#" title="" className="font-medium text-orange-400 transition-all duration-200 hover:underline">Contact our support</a></p>
    </div>
</section>
